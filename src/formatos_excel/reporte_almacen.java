...
public class reporte_almacen {
    ...
    public reporte_almacen(File file, String nombreTab, JTable tablaentrada, JTable tablasalida) {
        this.file = file;
    ...
    public reporte_almacen(File file, String nombreTab, JTable tablaentrada) {
        this.file = file;
        this.nombreTab = nombreTab;
        this.tablaentrada = tablaentrada;
...
public Boolean excel_export_reporte_resumenstock() throws IOException, WriteException{
        ...
        try{
            ...
            Label etiqueta_subtitulo = new Label(1, j, "DESCRIPCIÓN MATERIAL", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);
            
            etiqueta_subtitulo = new Label(2, j, "MARCA", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);
            
            etiqueta_subtitulo = new Label(3, j, "MODELO", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);
            
            etiqueta_subtitulo = new Label(4, j, "UMB", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(5, j, "CLASE MATERIAL", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(6, j, "GRUPO MATERIAL", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(7, j, "STOCK DISPONIBLE", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(8, j, "STOCK MÍNIMO", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(9, j, "STOCK MÁXIMO", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(10, j, "STOCK PEDIDO", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(11, j, "CANTIDAD ENTRANTE", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);    

            etiqueta_subtitulo = new Label(12, j, "CANTIDAD SALIENTE", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);    
            ...
            while(i < tablaentrada.getRowCount()){
                 etiqueta_subtitulo = new Label(0, j, tablaentrada.getValueAt(i,1).toString(), celda_datos); 
                 s.addCell(etiqueta_subtitulo);
                 etiqueta_subtitulo = new Label(1, j, tablaentrada.getValueAt(i,2).toString(), celda_datos); 
                 s.addCell(etiqueta_subtitulo);
                 etiqueta_subtitulo = new Label(2, j, tablaentrada.getValueAt(i,3).toString(), celda_datos); 
                 s.addCell(etiqueta_subtitulo);
                 etiqueta_subtitulo = new Label(3, j, tablaentrada.getValueAt(i,4).toString(), celda_datos); 
                 s.addCell(etiqueta_subtitulo);
                 etiqueta_subtitulo = new Label(4, j, tablaentrada.getValueAt(i,5).toString(), celda_datos); 
                 s.addCell(etiqueta_subtitulo);
                 etiqueta_subtitulo = new Label(5, j, tablaentrada.getValueAt(i,6).toString(), celda_datos); 
                 s.addCell(etiqueta_subtitulo);
                 etiqueta_subtitulo = new Label(6, j, tablaentrada.getValueAt(i,7).toString(), celda_datos); 
                 s.addCell(etiqueta_subtitulo);
                 etiqueta_subtitulo = new Label(7, j, tablaentrada.getValueAt(i,8).toString(), celda_datos); 
                 s.addCell(etiqueta_subtitulo);
...
public Boolean excel_export_reporte_tomafisica() throws IOException, WriteException{
        ...
        try{
            ...
            etiqueta_subtitulo = new Label(6, j, "ALMACÉN", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(7, j, "UBICACIÓN", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(8, j, "VALORACIÓN", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(9, j, "CANTIDAD SISTEMA", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(10, j, "CANTIDAD FÍSICA", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);

            etiqueta_subtitulo = new Label(11, j, "OBSERVACIÓN", celda_subtitulo); 
            s.addCell(etiqueta_subtitulo);    
