...
public class reporte_entrada {
    ...
    public reporte_entrada(File file, String nombreTab, JTable tablaentrada, JTable tablasalida) {
        this.file = file;
    ...
    public reporte_entrada(File file, String nombreTab, JTable tablaentrada) {
        this.file = file;
        this.nombreTab = nombreTab;
        this.tablaentrada = tablaentrada;
