 ...
 * @author ruben
 */
public class frm_anularreserva1 extends javax.swing.JFrame {

    private Integer fila_reserva;
    private Integer fila_posicion;
    public frm_anularreserva1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_encabezadoalmacen2.setText("ANULAR RESERVA");
        jPanel7.add(lbl_encabezadoalmacen2);
        lbl_encabezadoalmacen2.setBounds(290, 10, 140, 29);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        reserva.consultar_reserva_por_aprobar(Integer.parseInt(frm_principalM1.lbl_nivel.getText()),table_resumensolicitud);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_anularreserva1().setVisible(true);
            }
        });
    }
