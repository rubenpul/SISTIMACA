 ...
 * @author ruben
 */
public class frm_consultarordendecompra extends javax.swing.JFrame {

    /**
     * Creates new form frm_ordendecompra
     */
    public frm_consultarordendecompra() {
        initComponents();
        this.getContentPane().setBackground(new Color(245,245,245));
         this.setExtendedState(MAXIMIZED_BOTH);
         this.setTitle("SISTIMACA - CONSULTAR ORDEN DE COMPRA");
    ...
    private void initComponents() {
        ...
        if (table_resumenordendecompra.getColumnModel().getColumnCount() > 0) {
            ...
            table_resumenordendecompra.getColumnModel().getColumn(7).setMinWidth(0);
            table_resumenordendecompra.getColumnModel().getColumn(7).setPreferredWidth(0);
            table_resumenordendecompra.getColumnModel().getColumn(7).setMaxWidth(0);
        }
        ...
        lbl_encabezadoalmacen2.setText("CONSULTAR ORDENES DE COMPRA");
        jPanel7.add(lbl_encabezadoalmacen2);
        lbl_encabezadoalmacen2.setBounds(310, 10, 290, 29);
    ...
    private void table_posicioncompraMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_posicioncompraMousePressed
        ...
        frm_detalle_oc frm = new frm_detalle_oc(1);
        frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_consultarordendecompra().setVisible(true);
            }
        });
    }
