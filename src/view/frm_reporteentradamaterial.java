 ...
 * @author ruben
 */
public class frm_reporteentradamaterial extends javax.swing.JFrame {

    /**
     * Creates new form frm_reporteentradamaterial
     */
    public frm_reporteentradamaterial() {
        initComponents();
    ...
    private void bot_reiniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bot_reiniciarActionPerformed
        frm_reporteentradamaterial frm = new frm_reporteentradamaterial();
        frm.setVisible(true);
        this.dispose();
    ...
    private void bot_generarreporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bot_generarreporteActionPerformed
        ...
        String fecha_desde;
        String fecha_hasta;
        nombre_archivo = "\\\\192.168.0.3\\dist\\Documentos_SisTimaca";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_reporteentradamaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_reporteentradamaterial().setVisible(true);
            }
        });
    }
