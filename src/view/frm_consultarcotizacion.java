 ...
 * @author ruben
 */
public class frm_consultarcotizacion extends javax.swing.JFrame {

    /**
     * Creates new form frm_cotizacion
     */
    public frm_consultarcotizacion() {
        initComponents();
        
        this.setLocationRelativeTo(null);
        this.setTitle("SISTIMACA - CONSULTAR COTIZACIÓN");
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_titulodetallesolicitud, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 170, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 1330, 360));
        ...
        lbl_encabezadoalmacen2.setText("CONSULTAR COTIZACIÓN");
        ...
        getContentPane().add(radio_sinaprobar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 170, -1, -1));
        ...
        getContentPane().add(radio_aprobada, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 170, -1, -1));
        ...
        getContentPane().add(radio_autorizada, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 170, -1, -1));

        group_estatus.add(radio_anulada);
        ...
        getContentPane().add(radio_anulada, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 170, -1, -1));
        ...
        getContentPane().add(lbl_titulodetallesolicitud1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 210, -1, -1));
    ...
    private void table_posicioncotizacionMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_posicioncotizacionMousePressed
        ...
        frm_detalle_cotizacion frm = new frm_detalle_cotizacion();
        frm.setVisible(true);
    ...
    private void radio_anuladaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radio_anuladaActionPerformed
       ...
       if (!txt_numerosolicitud.getText().trim().equals("")){
        ...
        try {
            cotizacion.consultar_cotizacion(table_posicioncotizacion,3);
        } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_consultarcotizacion().setVisible(true);
            }
        });
    }
