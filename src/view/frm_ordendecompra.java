...
import formatos_pdf.pdf_ordencompra;
 ...
 * @author ruben
 */
public class frm_ordendecompra extends javax.swing.JFrame {
    ...
    public frm_ordendecompra() {
        ...
        this.getContentPane().setBackground(new Color(245,245,245));
         ...
         this.setTitle("SISTIMACA - GENERAR ORDEN DE COMPRA");
    ...
    private void initComponents() {
        ...
        bot_generardocumentocompra = new javax.swing.JButton();
        ...
        bot_completar = new javax.swing.JButton();
        bot_verdetalleoc = new javax.swing.JButton();
        ...
        getContentPane().add(lbl_titulodetallesolicitud, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 280, -1, -1));
        ...
        table_resumenordendecompra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "ORDEN DE COMPRA", "RIF", "PROVEEDOR", "CANTIDAD DE POSICIONES", "MONTO TOTAL", "MONEDA"
            }
        ) {
        ...
        bot_generardocumentocompra.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bot_generardocumentocompra.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/documento.png"))); // NOI18N
        bot_generardocumentocompra.setText("GENERAR ORDEN DE COMPRA");
        bot_generardocumentocompra.setEnabled(false);
        bot_generardocumentocompra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bot_generardocumentocompraActionPerformed(evt);
            }
        });
        getContentPane().add(bot_generardocumentocompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 560, 310, 40));
        complemento.DisableBorderButton(bot_generardocumentocompra);
        ...
        lbl_encabezadoalmacen2.setText("GENERAR ORDEN DE COMPRA");
        jPanel7.add(lbl_encabezadoalmacen2);
        lbl_encabezadoalmacen2.setBounds(310, 10, 240, 29);
        ...
        lbl_titulodetallesolicitud1.setText("ORDENES DE COMPRA POR GENERAR");
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 1330, 250));

        bot_completar.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bot_completar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/autorizar.png"))); // NOI18N
        bot_completar.setText("COMPLETAR DATOS O/C");
        bot_completar.setEnabled(false);
        bot_completar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bot_completarActionPerformed(evt);
            }
        });
        getContentPane().add(bot_completar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 560, -1, 40));

        bot_verdetalleoc.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bot_verdetalleoc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/documento.png"))); // NOI18N
        bot_verdetalleoc.setText("VER DETALLES ORDEN DE COMPRA");
        bot_verdetalleoc.setEnabled(false);
        bot_verdetalleoc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bot_verdetalleocActionPerformed(evt);
            }
        });
        getContentPane().add(bot_verdetalleoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 560, -1, 40));
    ...
    private void table_resumenordendecompraMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_resumenordendecompraMousePressed
        ...
        try { 
            cotizacion.consultar_cotizacion_autorizada_detalle(Integer.parseInt(frm_principalM1.lbl_nivel.getText()),table_posicioncompra);
        } catch (SQLException ex) {
            
        }
        
        if (table_resumenordendecompra.getValueAt(fila, 2).toString().equals("WEB") || table_resumenordendecompra.getValueAt(fila, 2).toString().equals("PART")){
            bot_generardocumentocompra.setEnabled(false);
        }
        else{
            bot_generardocumentocompra.setEnabled(true);
        }
    ...
    private void bot_generardocumentocompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bot_generardocumentocompraActionPerformed
       Integer fila;
     
        fila = table_resumenordendecompra.getSelectedRow();
   
        try {
            pdf_ordencompra.dato("\\\\192.168.0.3\\dist\\Documentos_SisTimaca",Integer.parseInt(table_resumenordendecompra.getValueAt(fila, 0).toString()),"");
        } catch (DocumentException | IOException ex) {
            Logger.getLogger(frm_entradaexpress.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(frm_entradaexpress.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_bot_generardocumentocompraActionPerformed
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try { 
            cotizacion.consultar_cotizacion_autorizada(Integer.parseInt(frm_principalM1.lbl_nivel.getText()),table_resumenordendecompra);
        } catch (SQLException ex) {
    ...
    private void table_posicioncompraMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_posicioncompraMousePressed
        ...
        bot_verdetalleoc.setEnabled(true);
        
        if(table_posicioncompra.getValueAt(fila, 5).toString().trim().equals("WEB") || table_posicioncompra.getValueAt(fila, 5).toString().trim().equals("PART")){
            bot_completar.setEnabled(true);
        }
    }//GEN-LAST:event_table_posicioncompraMousePressed

    private void bot_completarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bot_completarActionPerformed
       frm_detalleact_oc frm = new frm_detalleact_oc();
       frm.setVisible(true);
    }//GEN-LAST:event_bot_completarActionPerformed

    private void bot_verdetalleocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bot_verdetalleocActionPerformed
        frm_detalle_oc frm = new frm_detalle_oc(0);
        frm.setVisible(true);
    }//GEN-LAST:event_bot_verdetalleocActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_ordendecompra().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton bot_completar;
    private javax.swing.JButton bot_generardocumentocompra;
    protected static javax.swing.JButton bot_reiniciar;
    private javax.swing.JButton bot_verdetalleoc;
    ...
    protected static javax.swing.JTable table_resumenordendecompra;
