 ...
 * @author ruben
 */
public class frm_seguimientoreserva extends javax.swing.JFrame {

    private Integer fila_reserva;
    private Integer fila_posicion;
    public frm_seguimientoreserva() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_titulodetallereserva, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 80, -1, -1));
        ...
        getContentPane().add(lbl_desnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 520, -1, -1));

        lbl_desempresa.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(lbl_desempresa, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 440, -1, -1));

        lbl_desarea.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(lbl_desarea, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 560, -1, -1));

        lbl_desproyecto.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(lbl_desproyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 630, -1, -1));

        lbl_desgrupoarticulo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(lbl_desgrupoarticulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 560, -1, -1));

        lbl_descedula.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(lbl_descedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 480, -1, -1));

        lbl_desumb.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(lbl_desumb, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 520, -1, -1));
        getContentPane().add(lbl_desfecharequerida, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 440, -1, -1));

        lbl_desnumaterial.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(lbl_desnumaterial, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 440, -1, -1));

        lbl_desmaterial.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(lbl_desmaterial, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 480, -1, -1));

        bot_autorizar.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bot_autorizar.setIcon(new ImageIcon("imagenes/icon/autorizar.png"));
        bot_autorizar.setText("AUTORIZAR POSICION");
        ...
        table_detallereserva.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "POSICIÓN", "NRO MATERIAL", "MATERIAL SOLICITADO", "CANTIDAD RESERVADA", "UMB", "GRUPO DE ARTÍCULO", "FECHA REQUERIDA", "JUSTIFICACIÓN", "OBSERVACIÓN", "EMPRESA", "CEDULA", "NOMBRE", "DESCRIPCION AREA", "PROYECTO"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        getContentPane().add(lbl_titulodetallereserva1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 250, -1, -1));
        ...
        getContentPane().add(bot_anular, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 660, 250, 40));
        ...
        getContentPane().add(bot_revisar, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 660, 250, 40));
        ...
        lbl_cantidad.setBounds(358, 173, 177, 17);
        ...
        lbl_nombres.setBounds(30, 90, 72, 17);
        ...
        spin_cantidadautorizada.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        spin_cantidadautorizada.setModel(new javax.swing.SpinnerNumberModel(1, 1, null, 1));
        jPanel1.add(spin_cantidadautorizada);
        spin_cantidadautorizada.setBounds(538, 163, 80, 30);
        ...
        panel_foto.setBounds(788, 13, 160, 140);

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, 1240, 210));
        ...
        lbl_encabezadoalmacen2.setText("Seguimiento de Reserva");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        reserva = new ctrl_reserva(
            ...
            0,
            Integer.parseInt(frm_principal.lbl_cedula.getText()),
            Integer.parseInt(frm_principal.lbl_area.getText()),
            "",
            0,
            0, //numero de material
            "",             // descripcion de material
        ...
        reserva.consultar_reserva_por_aprobar(Integer.parseInt(frm_principal.lbl_nivel.getText()),table_resumenreserva);
    ...
    private void table_detallereservaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_detallereservaMousePressed
        ...
        lbl_desempresa.setText(table_detallereserva.getValueAt(fila_posicion, 9).toString());
        lbl_descedula.setText(table_detallereserva.getValueAt(fila_posicion, 10).toString());
        lbl_desnombre.setText(table_detallereserva.getValueAt(fila_posicion, 11).toString());
        lbl_desarea.setText(table_detallereserva.getValueAt(fila_posicion, 12).toString());
        lbl_desproyecto.setText(table_detallereserva.getValueAt(fila_posicion, 13).toString());
        lbl_desnumaterial.setText(table_detallereserva.getValueAt(fila_posicion, 1).toString());
        ...
        lbl_desgrupoarticulo.setText(table_detallereserva.getValueAt(fila_posicion, 5).toString());
        
        spin_cantidadautorizada.setValue(table_detallereserva.getValueAt(fila_posicion, 3));
        
        lbl_desfecharequerida.setText(table_detallereserva.getValueAt(fila_posicion, 6).toString());
        
        area_justificacion.setText(table_detallereserva.getValueAt(fila_posicion, 7).toString());
    ...
    private void bot_autorizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bot_autorizarActionPerformed
        ...
        ctrl_usuario usuario = new ctrl_usuario(
            ...
            if (respuesta == 0){
                firma = JOptionPane.showInputDialog("INTRODUZCA SU FIRMA DIGITAL PARA APROBAR");
                ...
                if(modelo_usuario.getFirmadigital().equals(firma)){
                    ...
                    ctrl_reserva reserva = new ctrl_reserva(
                        ...
                        "", //fecha reserva
                        "",
                        area_justificacion.getText().trim().toUpperCase() + " AUTORIZADO POR " + frm_principal.lbl_desnombres.getText(),
                        false,
                        "",
                        "",
                        "",
                    ...
                    if(reserva.autorizar_reserva_posicion_aprobar(Integer.parseInt(frm_principal.lbl_nivel.getText()))){
                        JOptionPane.showMessageDialog(null, "AUTORIZADO POSICION");
            ...
            if (respuesta == 0){
                ...
                if(modelo_usuario.getFirmadigital().equals(firma)){
                    ...
                    ctrl_reserva reserva = new ctrl_reserva(
                        ...
                        "", //fecha reserva
                        "",
                        area_justificacion.getText().trim().toUpperCase() + " ANULADO POR " + frm_principal.lbl_desnombres.getText(),
                        false,
                        "",
                        "",
                        "",
                    ...
                    if(reserva.autorizar_reserva_posicion_anular(Integer.parseInt(frm_principal.lbl_nivel.getText()))){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_seguimientoreserva().setVisible(true);
            }
        });
    }
