...
import formatos_pdf.pdf_devolucion;
...
public class frm_devolucion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DETALLES ORDEN DE COMPRA");
        ...
        tabla_ordendecompra.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        tabla_ordendecompra.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "id_almacen", "id_ubicacion", "oc", "id_proyecto", "id_usuario", "id_proveedor", "id_material", "NRO MATERIAL", "DESCRIPCIÓN", "CANTIDAD DISPONIBLE", "UMB", "POSICIÓN", "FECHA ENTRADA", "ALMACÉN", "UBICACIÓN", "PROYECTO", "USUARIO", "DOCUMENTO"
            }
        ) {
        ...
        tabla_ordendecompra.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tabla_ordendecompraMousePressed(evt);
            }
        });
        jScrollPane1.setViewportView(tabla_ordendecompra);
        if (tabla_ordendecompra.getColumnModel().getColumnCount() > 0) {
            tabla_ordendecompra.getColumnModel().getColumn(0).setMinWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(0).setPreferredWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(0).setMaxWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(1).setMinWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(1).setPreferredWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(1).setMaxWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(2).setMinWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(2).setPreferredWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(2).setMaxWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(3).setMinWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(3).setPreferredWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(3).setMaxWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(4).setMinWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(4).setPreferredWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(4).setMaxWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(5).setMinWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(5).setPreferredWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(5).setMaxWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(6).setMinWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(6).setPreferredWidth(0);
            tabla_ordendecompra.getColumnModel().getColumn(6).setMaxWidth(0);
        }

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 1310, 100));
        ...
        panel_proveedor.add(lbl_personacontacto, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 10, 270, 20));
        ...
        getContentPane().add(panel_proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 1310, 120));

        lbl_datosproveedor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_datosproveedor.setForeground(new java.awt.Color(0, 0, 255));
        lbl_datosproveedor.setText("DATOS PROVEEDOR");
        getContentPane().add(lbl_datosproveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 80, -1, -1));
        ...
        panel_devolucion.add(label_nromaterial, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 20, 230, 20));

        lbl_descripcionmaterial.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        panel_devolucion.add(lbl_descripcionmaterial, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 270, 20));

        lbl_umb.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        panel_devolucion.add(lbl_umb, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 70, 20));
        ...
        panel_devolucion.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, -1));

        jLabel21.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel21.setText("MOTIVO");
        panel_devolucion.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 110, -1, -1));

        jLabel22.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel22.setText("UNIDAD MEDIDA BASE");
        panel_devolucion.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, -1));

        cmb_motivo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cmb_motivo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmb_motivoActionPerformed(evt);
            }
        });
        panel_devolucion.add(cmb_motivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 110, 260, -1));

        txt_otromotivo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_otromotivo.setEnabled(false);
        panel_devolucion.add(txt_otromotivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 140, 260, -1));
        ...
        panel_devolucion.add(txt_cantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 100, -1));

        jLabel23.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel23.setText("CANTIDAD A DEVOLVER");
        panel_devolucion.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));

        lbl_cantidad.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        panel_devolucion.add(lbl_cantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 100, 20));

        bot_guardarfoto.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bot_guardarfoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/actualizar.png"))); // NOI18N
        ...
        panel_devolucion.add(bot_guardarfoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 70, 180, 30));
        ...
        panel_fotoLayout.setHorizontalGroup(
            ...
            .addComponent(lbl_foto, javax.swing.GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE)
        );
        panel_fotoLayout.setVerticalGroup(
            panel_fotoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_foto, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
        );

        panel_devolucion.add(panel_foto, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 10, 230, 150));

        jLabel24.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel24.setText("CANTIDAD DISPONIBLE");
        panel_devolucion.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, -1, -1));

        getContentPane().add(panel_devolucion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 1310, 170));
        ...
        getContentPane().add(bot_documento, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 650, -1, -1));
        ...
        getContentPane().add(bot_contabilizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 650, -1, -1));
        ...
        getContentPane().add(lbl_devolucion, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 520, -1, 20));
        ...
        tabla_devolucion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "id_almacen", "id_ubicacion", "id_usuario", "id_proyecto", "id_material", "id_proveedor", "oc", "NRO MATERIAL", "DESCRIPCION", "CANTIDAD", "UMB", "MOTIVO", "FECHA ENTRADA", "DOC ENTRADA", "FECHA DEVUELTA", "PROYECTO", "ORDEN DE COMPRA", "ALMACEN", "UBICACION", "USUARIO"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 540, 1310, 100));
        ...
        lbl_encabezadoalmacen2.setText("DEVOLUCIÓN MATERIAL");
        ...
        if ( ( (evt.getKeyCode() >= 48 ) && (evt.getKeyCode() <= 57 ) ) || ( (evt.getKeyCode() >= 37 ) && (evt.getKeyCode() <= 40 ) ) || ((evt.getKeyCode() >= 96 ) && (evt.getKeyCode() <= 105 )) || (evt.getKeyCode() == 144) || (evt.getKeyCode() == 127) || (evt.getKeyCode() == 8)  || (evt.getKeyCode() == 10)){       
           ...
           try {
               ...
               if (modelo_proveedor.getStatus()){
                   ...
                   devolucion.consultar_ordendecompra_detalle_devolucion(tabla_ordendecompra);
               }    
               else{
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ctrl_comun control = new ctrl_comun(18);
        cmb_motivo =  control.cargar_combo(cmb_motivo,"Seleccione...");
        txt_ordencompra.requestFocusInWindow();
    }//GEN-LAST:event_formWindowOpened

    private void tabla_ordendecompraMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_ordendecompraMousePressed
        Integer fila;
        fila = tabla_ordendecompra.getSelectedRow();
        label_nromaterial.setText(tabla_ordendecompra.getValueAt(fila, 7).toString());
        lbl_descripcionmaterial.setText(tabla_ordendecompra.getValueAt(fila, 8).toString());
        lbl_cantidad.setText(tabla_ordendecompra.getValueAt(fila, 9).toString());
        lbl_umb.setText(tabla_ordendecompra.getValueAt(fila, 10).toString());
        txt_cantidad.setEnabled(true);
    }//GEN-LAST:event_tabla_ordendecompraMousePressed
    ...
    private void cmb_motivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmb_motivoActionPerformed
       if(evt.getModifiers() != 0){
            ...
            if(!cmb_motivo.getSelectedItem().equals("Seleccione...")){
                if(cmb_motivo.getSelectedItem().toString().substring(4,cmb_motivo.getSelectedItem().toString().trim().length()).trim().equals("OTRO")){
                    txt_otromotivo.setEnabled(true);
    ...
    private void bot_contabilizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bot_contabilizarActionPerformed
       ...
       class_devolucion modelo_devolucion = null;
       Integer fila;
       
       fila = tabla_ordendecompra.getSelectedRow();
       
       fecha_devolucion = funciones.fecha_bd_usuario(funciones.getfechacalendario(), 2);
       
        if (!label_nromaterial.getText().trim().equals("") && !txt_cantidad.getText().trim().equals("") &&
            !cmb_motivo.getSelectedItem().equals("Seleccione...")){
           
                devolucion = new ctrl_devolucion(
                        0, //id_devolucion
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 6).toString()), //fk_material, 
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 3).toString()), // fk_proyecto, 
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 0).toString()), // fk_almacen, 
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 1).toString()), // fk_ubicacion, 
                        Integer.parseInt(cmb_motivo.getSelectedItem().toString().substring(0,3).trim())  , // fk_motivo, 
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 5).toString()), // fk_proveedor, 
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 4).toString()), // fk_usuario, 
                        tabla_ordendecompra.getValueAt(fila, 10).toString(), // codigo_umb, 
                        txt_otromotivo.getText().trim(), // descripcionmotivo, 
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 11).toString()), // posicion, 
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 17).toString()), // nro_documentoentrada, 
                        Integer.parseInt(txt_devolucion.getText().trim()), // nro_documentodevolucion, 
                        Integer.parseInt(tabla_ordendecompra.getValueAt(fila, 2).toString()), // orden_compra, 
                        tabla_ordendecompra.getValueAt(fila, 12).toString(), // fecha_entrada, 
                        Double.parseDouble(txt_cantidad.getText().trim()), // cantidad_devuelta, 
                        0.0, // cantidad_reingresada, 
                        "1900-01-01", // fecha_reingreso,
                        fecha_devolucion, // fecha_devuelta, 
                        image_string, // foto, 
                        true // estatus
                );
           try {
               modelo_devolucion = devolucion.crear_posicion(tabla_devolucion);
               bot_contabilizar.setEnabled(false);
               ...
               txt_otromotivo.setText("");
               txt_cantidad.setText("");
               cmb_motivo.setSelectedItem("Seleccione...");
               tabla_ordendecompra.setRowSelectionInterval(0, 0);
               
             
               
           } catch (SQLException ex) {
               JOptionPane.showMessageDialog(null,"ERROR EN AGREGAR DEVOLUCIÓN");
           }
            txt_devolucion.setText(modelo_devolucion.getNro_documentodevolucion().toString());
    ...
    private void bot_documentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bot_documentoActionPerformed
        try {
            pdf_devolucion.dato("C:/Documentos_sistimaca",Integer.parseInt(txt_devolucion.getText()),"");
           // pdf_devolucion.dato("\\\\192.168.0.3\\dist\\Documentos_SisTimaca",Integer.parseInt(txt_devolucion.getText()),"");
    ...
    private javax.swing.ButtonGroup bot_motivo;
    ...
    private javax.swing.JTable tabla_ordendecompra;
